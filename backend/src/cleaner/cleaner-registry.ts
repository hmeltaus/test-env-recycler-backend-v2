...
export class CleanerRegistry {
  ...
  constructor() {
    this.cleaners = [
      new S3BucketCleaner(this.regions),
      new LogGroupCleaner(this.regions),
      new VpcCleaner(this.regions),
      new CloudFormationStackCleaner(this.regions),
      new IgwCleaner(this.regions),
      new SubnetCleaner(this.regions),
      new NetworkAclCleaner(this.regions),
      new RouteTableCleaner(this.regions),
      new SecurityGroupCleaner(this.regions),
      new UserCleaner(this.regions),
      new SqsQueueCleaner(this.regions),
      new SnsTopicCleaner(this.regions),
      new SsmParameterCleaner(this.regions),
      new IamRoleCleaner(this.regions),
      new SecretCleaner(this.regions),
    ]
  }
